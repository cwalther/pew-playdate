...
SRC = src/main.c src/mphal.c src/terminal.c playdate-coroutines/pdco.c src/modules/_pew/mod_pew.c src/modules/_pew/vfs_pd.c src/modules/c_hello/modc_hello.c
